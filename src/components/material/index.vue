<template>
  <div v-if="type == 'image'">
    ...
    <div v-if="num > value.length" tabindex="0" class="el-upload el-upload--picture-card" :style="'width: '+width+'px;height: '+height+'px;'+'line-height:'+height+'px;'" @click="toSelectMaterial">
    ...
    <el-dialog title="图片素材库" append-to-body :visible.sync="listDialogVisible" width="70%">
        ...
        <el-main>
          <el-card>
            <div slot="header">
              <el-row>
                ...
                <el-col :span="12" style="text-align: right;">
                  <el-upload :action="uploadApi" :headers="headers" :file-list="[]" :on-progress="handleProgress" :before-upload="beforeUpload" :on-success="handleSuccess" multiple>
            ...
            <div v-loading="tableLoading">
              ...
              <el-pagination :current-page.sync="page.currentPage" :page-sizes="[12, 24]" :page-size="page.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="page.total" class="pagination" @size-change="sizeChange" @current-change="pageChange" />
            </div>
          </el-card>
        </el-main>
      </el-container>
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="sureUrls">确定</el-button>
      </span>
    </el-dialog>
  </div>
...
<script>
import { getGroups as materialgroupPage, add as materialgroupAdd, del as materialgroupDel, edit as materialgroupEdit } from '@/api/system/tools/materialGroup'
import { add, edit, del, getMaterials } from '@/api/system/tools/material'
  ...
  watch: {
    ...
    listDialogVisible(val) {
      if (val) {
        ...
        this.scrollStyle.height = (dialogHeight - 69 - 87) + 'px'
      }
    }
  },
  methods: {
    ...
    sureUrls() {
      ...
      this.$emit('selectMaterial', this.urls[0])
