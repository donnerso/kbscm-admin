      ...
      <el-table-column label="操作" width="160px" align="center" fixed="right">
        <template slot-scope="scope">
          <el-button size="mini" style="margin-right: 2px" type="text">
            <router-link :to="'/system/tools/generator/preview/' + scope.row.tableName">
              预览
            </router-link>
          </el-button>
          ...
          <el-button size="mini" style="margin-left: -1px;margin-right: 2px" type="text">
            <router-link :to="'/system/tools/generator/config/' + scope.row.tableName">
              配置
            </router-link>
          </el-button>
...
import { generator, sync } from '@/api/system/tools/generator/generator'
