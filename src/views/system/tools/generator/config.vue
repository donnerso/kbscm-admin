...
import { update, get } from '@/api/system/tools/generator/genConfig'
import { save, sync, generator } from '@/api/system/tools/generator/generator'
import { getDicts } from '@/api/system/tools/dict'
export default {
